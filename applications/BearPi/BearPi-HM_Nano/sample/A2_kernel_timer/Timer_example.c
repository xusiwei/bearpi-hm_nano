...
void Timer1_Callback (void *arg) {               // timer1 callback function
    (void)arg;
    printf("This is BearPi Harmony Timer1_Callback!\r\n");                                          
                                                
}

void Timer2_Callback (void *arg) {               // timer2 callback function
    (void)arg;
...
uint32_t exec1, exec2;                          // argument for the timer call back function
