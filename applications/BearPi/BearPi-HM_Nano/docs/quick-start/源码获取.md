...
1.  查找合适的解决方案组件包。
    ...
    4.  查找合适的解决方案，点击查看解决方案详情介绍。
        ...
        **图 1**  包管理<a name="fig838103114320"></a>  
        ...
        ![](/applications/BearPi/BearPi-HM_Nano/docs/quick-start/figures/zh-cn_image_0000001054919529.png)
...
2.  定制解决方案组件包。
    ...
    **图 2**  解决方案示例<a name="fig1329851510414"></a>  
    ...
    ![](/applications/BearPi/BearPi-HM_Nano/docs/quick-start/figures/zh-cn_image_0000001054719501.png)
